        ...
        if seven_days_urls:
             try:
                ...
                if date_xml_data:
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Failed', f'Duration of the scheduled assets is less than 20 minutes', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Not Tested', 'Start and Stop Tags are not available') if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Passed', f'Duration of the scheduled assets is greater than or equal to 20 minutes'))

                    sequence_number = sequence_number + 1

                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Failed', f'Duration of the scheduled assets is greater than 6 hours', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Not Tested', 'Start and Stop Tags are not available') if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Passed', f'Duration of the scheduled assets is less than or equal to 6 hours'))

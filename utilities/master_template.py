        ...
        if seven_days_urls:
            try:
                ...
                if date_xml_data:
                    ...
                    Validation_Output.append( helper_fuc(sequence_number, 'Asset_Level', f'Validate start time format for Assets in all 7 days', f'Start Time format should be in expected format for all Assets in all 7 days', 'Failed', f'Given assets are having wrong datetime format', ','.join(map(str, failed_cases))) if failed_cases else
                                              helper_fuc(sequence_number, 'Asset_Level', f'Validate start time format for Assets in all 7 days', f'Start Time format should be in expected format for all Assets in all 7 days', 'Not Tested', f'Start Time filed not available. Hence, skipping the validation of related test cases', ','.join(map(str, not_available_cases))) if not_available_cases else
                                              helper_fuc(sequence_number, 'Asset_Level', f'Validate start time format for Assets in all 7 days', f'Start Time format should be in expected format for all Assets in all 7 days', 'Not Tested', f'Start Time value not available. Hence, skipping the validation of related test cases', ','.join(map(str, no_value))) if no_value else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate end time format for Assets in all 7 days', f'End Time format should be in expected format for all Assets in all 7 days', 'Failed', f'Given assets are having wrong datetime format', ','.join(map(str, failed_cases))) if failed_cases else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate end time format for Assets in all 7 days', f'End Time format should be in expected format for all Assets in all 7 days', 'Not Tested', f'End Time not available. Hence, skipping the validation of related test cases', ','.join(map(str, not_available_cases))) if not_available_cases else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate end time format for Assets in all 7 days', f'End Time format should be in expected format for all Assets in all 7 days', 'Not Tested', 'End Time value not available. Hence, skipping the validation of related test cases', ','.join(map(str, no_value))) if no_value else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes (1200 seconds) of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Failed', f'Scheduled asset duration is less than the required 20 minutes (1200 seconds)', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes (1200 seconds) of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate less than 20 minutes (1200 seconds) of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be greater than or equal to 20 minutes for all Assets in all 7 days', 'Not Tested', 'Start and Stop Tags are not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours (21600 seconds) of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Failed', f'Scheduled asset duration exceeds the maximum allowed duration of 6 hours (21,600 seconds)', ','.join(map(str, results[3]))) if results[3] else
                                             ...
                                             helper_fuc(sequence_number, 'Schedule', f'Validate greater than 6 hours (21600 seconds) of Assets are not scheduled in all 7 days', f'Scheduled duration of Assets should be less than or equal to 6 hours for all Assets in all 7 days', 'Not Tested', 'Start and Stop Tags are not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate schedule gap between Assets in all 7 days', f'Current asset stop time and future asset start time should be equal for all Assets in all 7 days', 'Failed', f"Scheduling gap is observed between assets, where the current asset’s stop time not matching with subsequent asset’s start time", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate schedule gap between Assets in all 7 days', f'Current asset stop time and future asset start time should be equal for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate schedule gap between Assets in all 7 days', f'Current asset stop time and future asset start time should be equal for all Assets in all 7 days', 'Not Tested', 'Start and Stop Tags are not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Minutes attribute availability in all 7 days', f'Minutes attribute should be available for all Assets in all 7 days', 'Failed', f'Minutes attribute is missing', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Minutes attribute availability in all 7 days', f'Minutes attribute should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Minutes attribute availability in all 7 days', f'Minutes attribute should be available for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Minutes Value availability in all 7 days', f'Minutes Value should be available for all Assets in all 7 days', 'Failed', f'Minutes Value is missing', ','.join(map(str, results[7]))) if results[7] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Minutes Value availability in all 7 days', f'Minutes Value should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Minutes Value availability in all 7 days', f'Minutes Value should be available for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Minutes Value availability in all 7 days', f'Minutes Value should be available for all Assets in all 7 days', 'Not Tested', f'Minutes Attribute not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[6]))) if results[6] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in minutes match with Minutes Value in all 7 days', f'Minutes Value and Asset Duration in minutes should be equal for all Assets in all 7 days', 'Failed', f'Minutes value and the asset duration (in minutes) are not matching', ','.join(map(str, results[8]))) if results[8] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in minutes match with Minutes Value in all 7 days', f'Minutes Value and Asset Duration in minutes should be equal for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in minutes match with Minutes Value in all 7 days', f'Minutes Value and Asset Duration in minutes should be equal for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in minutes match with Minutes Value in all 7 days', f'Minutes Value and Asset Duration in minutes should be equal for all Assets in all 7 days', 'Not Tested', f'Minutes Attribute not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in minutes match with Minutes Value in all 7 days', f'Minutes Value and Asset Duration in minutes should be equal for all Assets in all 7 days', 'Not Tested', f'Minutes Value not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[7]))) if results[7] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Seconds attribute availability in all 7 days', f'Seconds attribute should be available for all Assets in all 7 days', 'Failed', f'Seconds attribute is missing', ','.join(map(str, results[11]))) if results[11] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Seconds attribute availability in all 7 days', f'Seconds attribute should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Seconds attribute availability in all 7 days', f'Seconds attribute should be available for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Seconds Value availability in all 7 days', f'Seconds Value should be available for all Assets in all 7 days', 'Failed', f'Seconds value is missing', ','.join(map(str, results[10]))) if results[10] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Seconds Value availability in all 7 days', f'Seconds Value should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Seconds Value availability in all 7 days', f'Seconds Value should be available for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Seconds Value availability in all 7 days', f'Seconds Value should be available for all Assets in all 7 days', 'Not Tested', f'Seconds Attribute not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[11]))) if results[11] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in seconds match with Seconds Value in all 7 days', f'Seconds Value and Asset Duration in seconds should be equal for all Assets in all 7 days', 'Failed', f'Seconds value and the asset duration (in seconds) are not matching', ','.join(map(str, results[9]))) if results[9] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in seconds match with Seconds Value in all 7 days', f'Seconds Value and Asset Duration in seconds should be equal for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in seconds match with Seconds Value in all 7 days', f'Seconds Value and Asset Duration in seconds should be equal for all Assets in all 7 days', 'Not Tested', f'Schedule Length Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in seconds match with Seconds Value in all 7 days', f'Seconds Value and Asset Duration in seconds should be equal for all Assets in all 7 days', 'Not Tested', f'Seconds Attribute not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[11]))) if results[11] else
                                             helper_fuc(sequence_number, 'Schedule', f'Validate Asset Duration in seconds match with Seconds Value in all 7 days', f'Seconds Value and Asset Duration in seconds should be equal for all Assets in all 7 days', 'Not Tested', f'Seconds Value not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[10]))) if results[10] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title availability in all 7 days', f'Asset Title should be available for all Assets in all 7 days', 'Failed', f'Asset title not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title availability in all 7 days', f'Asset Title should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title availability in all 7 days', f'Asset Title should be available for all Assets in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate To Be Announced Assets in all 7 days', f'Asset Title field should not include To Be Announced for all Assets in all 7 days', 'Failed', f'Title field contains the value of "To Be Announced"', ','.join(map(str, results[9]))) if results[9] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate To Be Announced Assets in all 7 days', f'Asset Title field should not include To Be Announced for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate To Be Announced Assets in all 7 days', f'Asset Title field should not include To Be Announced for all Assets in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title and Description are matching in all 7 days', f'Asset Title and Description should not be same for all Assets in all 7 days', 'Failed', f'Asset Title and Description fields are matching"', ','.join(map(str, results[8]))) if results[8] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title and Description are matching in all 7 days', f'Asset Title and Description should not be same for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Title and Description are matching in all 7 days', f'Asset Title and Description should not be same for all Assets in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Asset Title in all 7 days', f'Length of Asset Title should not exceed 200 characters for all Assets in all 7 days', 'Failed', f'Asset Title having in-correct-length (chars) which exceeds the maximum allowed length of 200 characters', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Asset Title in all 7 days', f'Length of Asset Title should not exceed 200 characters for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Asset Title in all 7 days', f'Length of Asset Title should not exceed 200 characters for all Assets in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Asset Title in all 7 days', f'Asset Title should not have any special characters for all Assets in all 7 days', 'Failed', f'Asset title contains special characters that are not permitted according to the platform standards', ','.join(map(str, results[7]))) if results[7] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Asset Title in all 7 days', f'Asset Title should not have any special characters for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Asset Title in all 7 days', f'Asset Title should not have any special characters for all Assets in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for title tag in all 7 days', f'Title tag should include language in all 7 days', 'Failed', f"Language node is missing from the title tag", ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for title tag in all 7 days', f'Title tag should include language in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for title tag in all 7 days', f'Title tag should include language in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Title_Language tag should be equal in all 7 days', 'Failed', f"Title_language_node having (lang value) and channel_level_language having channel_lang_value are not matching", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Title_Language tag should be equal in all 7 days', 'Not Tested', f'Title_language node not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Title_Language tag should be equal in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Title_Language tag should be equal in all 7 days', 'Not Tested', f'Title Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Sub-Title availability in all 7 days', f'Asset Sub-Title should be available for all Assets in all 7 days', 'Failed', f'Asset Sub-Title not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Sub-Title availability in all 7 days', f'Asset Sub-Title should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Sub-Title availability in all 7 days', f'Asset Sub-Title should be available for all Assets in all 7 days', 'Not Tested', 'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Sub-Title availability in all 7 days', f'Asset Sub-Title should be available for all Assets in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Asset Title are matching in all 7 days', f'Sub-Title and Asset Title should not be same for all Assets in all 7 days', 'Failed', f'Sub-Title and Asset Title fields are matching"', ','.join(map(str, results[8]))) if results[8] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Asset Title are matching in all 7 days', f'Sub-Title and Asset Title should not be same for all Assets in all 7 days', 'Not Tested', 'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Asset Title are matching in all 7 days', f'Sub-Title and Asset Title should not be same for all Assets in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Description are matching in all 7 days', f'Sub-Title and Description should not be same for all Assets in all 7 days', 'Failed', f'Sub-Title and Description fields are matching"', ','.join(map(str, results[10]))) if results[10] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Description are matching in all 7 days', f'Sub-Title and Description should not be same for all Assets in all 7 days', 'Not Tested', f'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title and Description are matching in all 7 days', f'Sub-Title and Description should not be same for all Assets in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Sub-Title in all 7 days', f'Length of Sub-Title should not exceed 200 characters for all Assets in all 7 days', 'Failed', f'Sub-Title having in-correct-length (chars) which exceeds the maximum allowed length of 200 characters', ','.join(map(str, results[6]))) if results[6] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Sub-Title in all 7 days', f'Length of Sub-Title should not exceed 200 characters for all Assets in all 7 days', 'Not Tested', f'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Sub-Title in all 7 days', f'Length of Sub-Title should not exceed 200 characters for all Assets in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Sub-Title in all 7 days', f'Sub-Title should not have any special characters for all Assets in all 7 days', 'Failed', f'Sub-Title contains special characters that are not permitted according to the platform standards', ','.join(map(str, results[7]))) if results[7] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Sub-Title in all 7 days', f'Sub-Title should not have any special characters for all Assets in all 7 days', 'Not Tested', f'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Sub-Title in all 7 days', f'Sub-Title should not have any special characters for all Assets in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Sub-Title tag in all 7 days', f'Sub-Title tag should include language in all 7 days', 'Failed', f"Language node is missing from the sub-title tag", ','.join(map(str, results[3]))) if results[3] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Sub-Title tag in all 7 days', f'Sub-Title tag should include language in all 7 days', 'Not Tested', f'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Sub-Title tag in all 7 days', f'Sub-Title tag should include language in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Sub-Title_Language tag should be equal in all 7 days', 'Failed', f"Sub-Title_language node having (lang value) and channel_level_language having channel_lang_value are not matching", ','.join(map(str, results[4]))) if results[4] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Sub-Title_Language tag should be equal in all 7 days', 'Not Tested', f'Sub-title test case was not tested because the dependent test cases failed.', ','.join(map(str, results[1]))) if results[1] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Sub-Title_Language node match with Channel_Language in all 7 days', f'Channel_Language and Sub-Title_Language tag should be equal in all 7 days', 'Not Applicable', 'Sub-title test case not applicable for Non-Episodic assets', ','.join(map(str, results[1]))) if results[1] and all(others) else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Description availability in all 7 days', f'Asset Description should be available for all Assets in all 7 days', 'Failed', f'Asset Description not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Description availability in all 7 days', f'Asset Description should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Description availability in all 7 days', f'Asset Description should be available for all Assets in all 7 days', 'Not Tested', f'Description Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Description in all 7 days', f'Length of Description should not exceed 4000 characters for all Assets in all 7 days', 'Failed', f'Description having in-correct-length (chars) which exceeds the maximum allowed length of 4000 characters', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Description in all 7 days', f'Length of Description should not exceed 4000 characters for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Length of Description in all 7 days', f'Length of Description should not exceed 4000 characters for all Assets in all 7 days', 'Not Tested', f'Description Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Description in all 7 days', f'Description should not have any special characters for all Assets in all 7 days', 'Failed', f'Description contains special characters that are not permitted according to the platform standards', ','.join(map(str, results[7]))) if results[7] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Description in all 7 days', f'Description should not have any special characters for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Special Characters in Description in all 7 days', f'Description should not have any special characters for all Assets in all 7 days', 'Not Tested', f'Description Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Description tag in all 7 days', f'Description tag should include language in all 7 days', 'Failed', f"Language node is missing from the description tag", ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Description tag in all 7 days', f'Description tag should include language in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Description tag in all 7 days', f'Description tag should include language in all 7 days', 'Not Tested', f'Description Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Description_Language node match with Channel_Language in all 7 days', f'Channel_Language and Description_Language tag should be equal in all 7 days', 'Failed', f"Description_language having lang value and channel_level_language having channel_lang_value are not matching", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Description_Language node match with Channel_Language in all 7 days', f'Channel_Language and Description_Language tag should be equal in all 7 days', 'Not Tested', f'Description_language node not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Description_Language node match with Channel_Language in all 7 days', f'Channel_Language and Description_Language tag should be equal in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Description_Language node match with Channel_Language in all 7 days', f'Channel_Language and Description_Language tag should be equal in all 7 days', 'Not Tested', f'Description Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Category availability in all 7 days', f'Asset Category should be available for all Assets in all 7 days', 'Failed', f'Asset Category not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Category availability in all 7 days', f'Asset Category should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Category availability in all 7 days', f'Asset Category should be available for all Assets in all 7 days', 'Not Tested', f'Category Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Category tag in all 7 days', f'Category tag should include language in all 7 days', 'Failed', f"Language node is missing from the Category tag", ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Category tag in all 7 days', f'Category tag should include language in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate language node availability for Category tag in all 7 days', f'Category tag should include language in all 7 days', 'Not Tested', f'Category Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Category_Language node match with Channel_Language in all 7 days', f'Channel_Language and Category_Language tag should be equal in all 7 days', 'Failed', f"Category_language lang value and channel_level_language having channel_lang_value are not matching", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category_Language node match with Channel_Language in all 7 days', f'Channel_Language and Category_Language tag should be equal in all 7 days', 'Not Tested', f'Category_language node not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category_Language node match with Channel_Language in all 7 days', f'Channel_Language and Category_Language tag should be equal in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category_Language node match with Channel_Language in all 7 days', f'Channel_Language and Category_Language tag should be equal in all 7 days', 'Not Tested', f'Category Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Category as per Samsung standard in all 7 days', f'Category should present in Samsung_Supported_Category_List in all 7 days', 'Failed', f"Given assets contain invalid categories that are not included in the Samsung_Supported_Category_List", ','.join(map(str, results[5]))) if results[5] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category as per Samsung standard in all 7 days', f'Category should present in Samsung_Supported_Category_List in all 7 days', 'Not Tested', f'Category_language node not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category as per Samsung standard in all 7 days', f'Category should present in Samsung_Supported_Category_List in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Category as per Samsung standard in all 7 days', f'Category should present in Samsung_Supported_Category_List in all 7 days', 'Not Tested', f'Category Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language availability in all 7 days', f'Asset Language should be available for all Assets in all 7 days', 'Failed', f'Asset Language not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language availability in all 7 days', f'Asset Language should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language availability in all 7 days', f'Asset Language should be available for all Assets in all 7 days', 'Not Tested', f'Language Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset_Language should be equal in all 7 days', 'Failed', f"Asset_Language not same as channel_language", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset_Language should be equal in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset_Language should be equal in all 7 days', 'Not Tested', f'Asset_Language Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Orig_Language availability in all 7 days', f'Asset Orig_Language should be available for all Assets in all 7 days', 'Failed', f'Asset Orig_Language not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Orig_Language availability in all 7 days', f'Asset Orig_Language should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Orig_Language availability in all 7 days', f'Asset Orig_Language should be available for all Assets in all 7 days', 'Not Tested', f'Orig_Language Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Orig-language Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset Orig_Language should be equal in all 7 days', 'Failed', f"Asset Orig_Language not same as channel_language", ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Orig-language Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset Orig_Language should be equal in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Orig-language Asset_Language value match with Channel_Language in all 7 days', f'Channel_Language and Asset Orig_Language should be equal in all 7 days', 'Not Tested', f'Asset Orig_Language Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail availability in all 7 days', f'Asset Thumbnail should be available for all Assets in all 7 days', 'Failed', f'Asset Thumbnail not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail availability in all 7 days', f'Asset Thumbnail should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail availability in all 7 days', f'Asset Thumbnail should be available for all Assets in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width availability in all 7 days', f'Asset Thumbnail_Width should be available for all Assets in all 7 days', 'Failed', f'Asset Thumbnail_Width not available', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width availability in all 7 days', f'Asset Thumbnail_Width should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width availability in all 7 days', f'Asset Thumbnail_Width should be available for all Assets in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height availability in all 7 days', f'Asset Thumbnail_Height should be available for all Assets in all 7 days', 'Failed', f'Asset Thumbnail_Height not available', ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height availability in all 7 days', f'Asset Thumbnail_Height should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height availability in all 7 days', f'Asset Thumbnail_Height should be available for all Assets in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_URL Length in all 7 days', f'Length of Asset Thumbnail_URL should not exceed 2000 characters in all 7 days', 'Failed', f'Asset Thumbnail_URL length is in-correct-length which is more than expected limit of 2000 characters', ','.join(map(str, results[5]))) if results[5] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_URL Length in all 7 days', f'Length of Asset Thumbnail_URL should not exceed 2000 characters in all 7 days', 'Not Tested', f'Asset Thumbnail not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_URL Length in all 7 days', f'Length of Asset Thumbnail_URL should not exceed 2000 characters in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_URL Length in all 7 days', f'Length of Asset Thumbnail_URL should not exceed 2000 characters in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail status code in all 7 days', f'Asset Thumbnail should open with 200 OK Status Code in all 7 days', 'Failed', f'Asset Thumbnail request getting in-correct-thumbnail status code', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail status code in all 7 days', f'Asset Thumbnail should open with 200 OK Status Code in all 7 days', 'Not Tested', f'Asset Thumbnail not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail status code in all 7 days', f'Asset Thumbnail should open with 200 OK Status Code in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail status code in all 7 days', f'Asset Thumbnail should open with 200 OK Status Code in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Format in all 7 days', f'Asset Thumbnail Format should be JPEG/JPG in all 7 days', 'Failed', f'Asset Thumbnail are having in-correct-thumbnail format. But, expected should be JPEG/JPG format', ','.join(map(str, results[8]))) if results[8] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Format in all 7 days', f'Asset Thumbnail Format should be JPEG/JPG in all 7 days', 'Not Tested', f'Asset Thumbnail not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Format in all 7 days', f'Asset Thumbnail Format should be JPEG/JPG in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Format in all 7 days', f'Asset Thumbnail Format should be JPEG/JPG in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Resolution in all 7 days', f'Asset Thumbnail should be 1920X1080 resolution in all 7 days', 'Failed', f'Asset Thumbnail are having in-correct-thumbnail resolution. But, expected should be 1920X1080 resolution', ','.join(map(str, results[9]))) if results[9] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Resolution in all 7 days', f'Asset Thumbnail should be 1920X1080 resolution in all 7 days', 'Not Tested', f'Asset Thumbnail not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Resolution in all 7 days', f'Asset Thumbnail should be 1920X1080 resolution in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Resolution in all 7 days', f'Asset Thumbnail should be 1920X1080 resolution in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width XML_thumbnail_width in all 7 days', f'Asset Thumbnail_Width should match with XML_thumbnail_width for all Assets in all 7 days', 'Failed', f'Asset Thumbnail_Width having in-correct length and XML_thumbnail_width having proper-length are not matching', ','.join(map(str, results[10]))) if results[10] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width XML_thumbnail_width in all 7 days', f'Asset Thumbnail_Width should match with XML_thumbnail_width for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Width XML_thumbnail_width in all 7 days', f'Asset Thumbnail_Width should match with XML_thumbnail_width for all Assets in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height XML_thumbnail_height in all 7 days', f'Asset Thumbnail_Height should match with XML_thumbnail_height for all Assets in all 7 days', 'Failed', f'Asset Thumbnail_Height having in-correct length and XML_thumbnail_height having proper-length are not matching', ','.join(map(str, results[11]))) if results[11] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height XML_thumbnail_height in all 7 days', f'Asset Thumbnail_Height should match with XML_thumbnail_height for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail_Height XML_thumbnail_height in all 7 days', f'Asset Thumbnail_Height should match with XML_thumbnail_height for all Assets in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append( helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Aspect Ratio in all 7 days', f'Asset Thumbnail should have 16:9 aspect aspect-ratio in all 7 days', 'Failed', f'Asset Thumbnail are having in-correct-thumbnail aspect ratio. But, expected should be 16:9 aspect-ratio', ','.join(map(str, results[12]))) if results[12] else
                                              helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Aspect Ratio in all 7 days', f'Asset Thumbnail should have 16:9 aspect aspect-ratio in all 7 days', 'Not Tested', f'Asset Thumbnail not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[2]))) if results[2] else
                                              helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Aspect Ratio in all 7 days', f'Asset Thumbnail should have 16:9 aspect aspect-ratio in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                              helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset Thumbnail Aspect Ratio in all 7 days', f'Asset Thumbnail should have 16:9 aspect aspect-ratio in all 7 days', 'Not Tested', f'Icon Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Source availability in all 7 days', f'Rating Source should be available for all Assets in all 7 days', 'Failed', f'Rating Source not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Source availability in all 7 days', f'Rating Source should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Source availability in all 7 days', f'Rating Source should be available for all Assets in all 7 days', 'Not Tested', f'Rating Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Source as per Samsung standard in all 7 days', f'Rating Source should present in Samsung_Supported_Rating_Source_List in all 7 days', 'Failed', f'Assets are having (in-correct-rating) rating source which is not expected as per platform standard', ','.join(map(str, results[3]))) if results[3] else
                                             ...
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Source as per Samsung standard in all 7 days', f'Rating Source should present in Samsung_Supported_Rating_Source_List in all 7 days', 'Not Tested', f'Rating Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value availability in all 7 days', f'Rating Value should be available for all Assets in all 7 days', 'Failed', f'Rating Value not available', ','.join(map(str, results[4]))) if results[4] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value availability in all 7 days', f'Rating Value should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value availability in all 7 days', f'Rating Value should be available for all Assets in all 7 days', 'Not Tested', f'Rating Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value as per Samsung standard in all 7 days', f'Rating Source Value present in Samsung_Supported_Rating_Value_List in all 7 days', 'Failed', f'Assets are having (in-correct-rating) rating value are not included in Samsung_Supported_Category_List', ','.join(map(str, results[5]))) if results[5] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value as per Samsung standard in all 7 days', f'Rating Source Value present in Samsung_Supported_Rating_Value_List in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Rating Value as per Samsung standard in all 7 days', f'Rating Source Value present in Samsung_Supported_Rating_Value_List in all 7 days', 'Not Tested', f'Rating Tag not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[1]))) if results[1] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID availability in all 7 days', f'Asset ID should be available for all Assets in all 7 days', 'Failed', f'Asset ID not available', ','.join(map(str, results[2]))) if results[2] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID availability in all 7 days', f'Asset ID should be available for all Assets in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID availability in all 7 days', f'Asset ID should be available for all Assets in all 7 days', 'Not Tested', f'Asset ID Tag itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[8]))) if results[8] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID Length in all 7 days', f'Length of Asset ID should not exceed 50 characters in all 7 days', 'Failed', f'Asset ID length is in-correct-length which is more than expected limit of 50 characters', ','.join(map(str, results[6]))) if results[6] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID Length in all 7 days', f'Length of Asset ID should not exceed 50 characters in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Asset ID Length in all 7 days', f'Length of Asset ID should not exceed 50 characters in all 7 days', 'Not Tested', f'Asset ID Tag itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[8]))) if results[8] else
                    ...
                    Validation_Output.append(helper_fuc(sequence_number, 'Asset_Level', f'Validate Episode Number value availability in all 7 days', f'Episode Number Value should be available in all 7 days', 'Failed', f'Episode Number Value not available', ','.join(map(str, results[3]))) if results[3] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Episode Number value availability in all 7 days', f'Episode Number Value should be available in all 7 days', 'Not Tested', f'Main Programme Field itself not available. Hence, skipping the validation of related test cases', ','.join(map(str, results[0]))) if results[0] else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Episode Number value availability in all 7 days', f'Episode Number Value should be available in all 7 days', 'Not Tested', f'Episode Number test case was not tested because the dependent test cases failed.', ','.join(map(str, results[7]))) if results[7] and any(episode) else
                                             helper_fuc(sequence_number, 'Asset_Level', f'Validate Episode Number value availability in all 7 days', f'Episode Number Value should be available in all 7 days', 'Not Applicable', 'Episode Number test case not applicable for Non-Episodic assets', ','.join(map(str, results[7]))) if results[7] and all(others) else
